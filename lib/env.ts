...
const schema = z.object({
  ...
  // Read directly by @workos-inc/authkit-nextjs as a default redirectUri.
  // lib/workos.ts overrides it for sign-in/sign-up flows, but session
  // refresh and other internal AuthKit paths fall back to this env var.
